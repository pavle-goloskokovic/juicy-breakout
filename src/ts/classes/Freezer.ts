...
export default class Freezer {
    ...
    static get multiplier (): number
    {
        ...
        {
            return this.lerp(1, Settings.EFFECT_FREEZE_SPEED_MULTIPLIER, time / Settings.EFFECT_FREEZE_FADE_IN_MS);
        }
        ...
        {
            return this.lerp(Settings.EFFECT_FREEZE_SPEED_MULTIPLIER, 1, time / Settings.EFFECT_FREEZE_FADE_OUT_MS);
        }
