...
export class PieChart extends Chart {
    ...
    {
        const radius: number = Math.min(this.width - 40, this.height - 40) / 2;
    ...
    protected getLabelForData (index: number): string
    {
        ...
        const value: number = Math.round(this.getValueForData(index) * Math.pow(10, this._labelPrecision)) / Math.pow(10, this._labelPrecision);
