...
export class Meter extends Component {
    ...
    public draw(): void {
        let startAngle: number = -140 * Math.PI / 180;
        let endAngle: number = -40 * Math.PI / 180;
        this.drawBackground();
    ...
    protected drawDial(startAngle: number, endAngle: number): void {
        ...
        let r1: number = this._height * 1.05;
        let r2: number = this._height * 0.96;
    ...
    protected drawTicks(startAngle: number, endAngle: number): void {
        let r1: number = this._height * 1.05;
        let r2: number = this._height * 0.96;
        let r3: number = this._height * 1.13;
        let tick: number = 0;
        for(let i: number = 0; i < 9; i++) {
            let angle: number = startAngle + i * (endAngle - startAngle) / 8;
