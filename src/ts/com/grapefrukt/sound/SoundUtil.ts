...
export class SoundUtil {
    public static stageWidth = 800;
    public static stereoSeparation = 0.75;
    public static globalVolume = 1;
    public static playAtSprite (sound: Sound, target: DisplayObject = null, volume = 1, loops = 0): SoundChannel
    {
        return SoundUtil.play(sound, volume, SoundUtil.getPan(target), loops);
    }

    public static playClassAtSprite (soundClass: Class, target: DisplayObject = null, volume = 1, loops = 0): SoundChannel
    {
        return SoundUtil.playAtSprite(SoundUtil.getClassAsSound(soundClass), target, volume, loops);
    }

    public static play (sound: Sound, volume = 1, pan = 0, loops = 0): SoundChannel
    {
        return sound.play(0, loops, SoundUtil.generateTransform(volume, pan));
    }

    public static playClass (soundClass: Class, volume = 1, pan = 0, loops = 0): SoundChannel
    {
    ...
    public static generateTransform (volume = 1, pan = 0): SoundTransform
    {
    ...
    public static setNewTransform (soundChannel: SoundChannel, volume = 1, pan = 0): void
    {
        soundChannel.soundTransform = SoundUtil.generateTransform(volume, pan);
    }

    public static updateTransformAtSprite (soundChannel: SoundChannel, target: DisplayObject = null, volume = 1): void
    {
